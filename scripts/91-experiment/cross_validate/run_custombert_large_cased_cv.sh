...
export MODEL_NAME_OR_PATH="/users5/kliao/manual_cache/pytorch_transformers/bert-large-cased"
export OUTPUT_DIR="random_split_output/SemEval-2020-Task5/custombert-large-cased"
export K=10
