...
export MODEL_NAME_OR_PATH="/users5/kliao/manual_cache/pytorch_transformers/bert-base-cased"
export OUTPUT_DIR="random_split_output/SemEval-2020-Task5/bert-base-cased"
export K=10
