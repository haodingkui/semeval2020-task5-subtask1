...
export MODEL_NAME_OR_PATH="/users5/dkhao/data/transformers/albert-xxlarge-v2"
export OUTPUT_DIR="output/SemEval-2020-Task5/albert-xxlarge-v2"
export K=10
...
do
  ...
  echo $i
  python -m torch.distributed.launch --nproc_per_node 3 run_transformers.py   \
